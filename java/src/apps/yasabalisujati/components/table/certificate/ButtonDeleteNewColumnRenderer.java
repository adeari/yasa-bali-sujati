...
public class ButtonDeleteNewColumnRenderer  extends DefaultCellEditor {
	private static final long serialVersionUID = 6951562338233919355L;
	protected Button button;
    private String label;
    private CertificateTambah _certificateTambah;

    public ButtonDeleteNewColumnRenderer(JCheckBox checkBox,CertificateTambah certificateTambah) {
    	super(checkBox);
    ...
    public Component getTableCellEditorComponent(JTable table, Object value,
    	...
    	_certificateTambah.deleteNewColumn((CertificateNewColumn) table.getValueAt(row, 4));
        return button;
    }

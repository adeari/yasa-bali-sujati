...
public class ShipperIndex extends JInternalFrame {
	...
	private final String[] kolom = new String[] { "", "Nama Perusahaan", "Detail", "Jenis Shipper", "" };
	...
	private ShipperTambah _shipperTambah;
	
	private String[] jenisShipperShow = new String[] {"Exportir", "Importir" };

	public ShipperIndex(Session session, Service service, SimpleDateFormat simpleDateFormat) {
		super("Shipper", true, true, true, true);
		_frame = this;
		...
		baruButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				_shipperTambah.setVisible(null);
			}
		});
		...
		table.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (e.getClickCount() == 2) {
					_shipperTambah.setVisible((Customer) table.getValueAt(
	...
	public Criteria setCriteriaCondition(Criteria criteria) {
		criteria.add(Restrictions.in("jenisCustomer", jenisShipperShow));
	...
	public void showUpdateForm() {
		...
		if (countSelected == 0) {
			...
			_shipperTambah.setVisible(customers.get(0));
		} else {
			JOptionPane.showMessageDialog(null,

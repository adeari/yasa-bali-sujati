...
import apps.yasabalisujati.components.Frame;
...
public class Login extends Frame {
	...
	public Login(String title) {
		...
		buttonSavePanel.setPreferredSize(new Dimension(Double.valueOf(formPanel.getPreferredSize().getWidth()).intValue() - 5, 40));
		buttonSavePanel.setBorder(BorderFactory.createTitledBorder(""));
		
		Button loginButton = new Button(new ImageIcon(Login.class.getResource("../icons/key.png")), "L O G I N");
		...
		Button tutupButton = new Button(new ImageIcon(Login.class.getResource("../icons/cancel.png")), "T U T U P");
	...
	public void refreshDivisiUser() {
		...
		Criteria criteria = _session.createCriteria(User.class).setProjection(Projections.groupProperty("divisi"));

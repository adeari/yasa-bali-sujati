...
<div></div>
    ...
    <footer class="row">
        <p class="col-md-9 col-sm-9 col-xs-12 copyright">&copy; <a href="http://usman.it" target="_blank">PT. YASA BALI SUJATI</a> 2015</p>
...
<script src="{{ URL::to("public/komponenku/charisma") }}/js/myjs.js"></script>
<script src="{{ URL::to("public/komponenku/jquery.mask.min.js") }}"></script>
</body>
</html>
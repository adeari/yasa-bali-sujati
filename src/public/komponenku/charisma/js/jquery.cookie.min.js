...
if(f===null||f===undefined){k.expires=-1;}if(typeof k.expires==="number"){var h=k.expires,j=k.expires=new Date();j.setDate(j.getDate()+h);}f=String(f);
...
}k=f||{};var b=k.raw?function(i){return i;}:decodeURIComponent;var c=document.cookie.split("; ");for(var e=0,d;d=c[e]&&c[e].split("=");e++){if(b(d[0])===g){return b(d[1]||"");
}}return null;};})(jQuery);
$(document).ready(function () {
    ...
    function switchTheme(themeName) {
        if (themeName == 'classic') {
            $('#bs-css').attr('href', 'public/komponenku/charisma/bower_components/bootstrap/dist/css/bootstrap.min.css');
        } else {
            $('#bs-css').attr('href', 'public/komponenku/charisma/css/bootstrap-' + themeName + '.min.css');
        }
...
function docReady() {
    ...
    $('.chosen-container-single').css('height','38px');
    ...
    $('.datatable').dataTable({
        ...
        "oLanguage": {
            "sLengthMenu": "_MENU_ baris tiap halaman",
            "sZeroRecords": "Tidak ada data",
            "sInfo": "Data ke _START_ sampai _END_ dari _TOTAL_ records",
            "sInfoEmpty": "",
